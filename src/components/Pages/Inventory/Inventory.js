                ...
                <div className="add-product-form">
                    <form>
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    onChange={handleInput}
                                />
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.product_code != undefined ? errors.product_code[0] : null}</small></p>
                            </div>
                            <div className="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    onChange={handleInput}
                                />
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.price != undefined ? errors.price[0] : null}</small></p>
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    onChange={handleInput}
                                />
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.supplier != undefined ? errors.supplier[0] : null}</small></p>
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    onChange={handleInput}
                                />
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.quantity != undefined ? errors.quantity[0] : null}</small></p>
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.category_id != undefined ? errors.category_id[0] : null}</small></p>
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.purchase_type_id != undefined ? errors.purchase_type_id[0] : null}</small></p>
                            ...
                            <div className=" col-md-6 mb-3">
                                ...
                                />
                                <p className={'login-error-message'}><small className={'text-danger'}>{errors.image != undefined ? errors.image[0] : null}</small></p>
                        ...
                        <div className='text-center'>
                            <button type="button" className=" my-2 btn btn-primary" onClick={handleSubmit}>Add Product
                            </button>
                        </div>
                    </form>
